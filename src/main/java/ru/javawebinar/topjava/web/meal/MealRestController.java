...
public class MealRestController {
    ...
    public Collection<MealWithExceed> getAll() {
        ...
        return convertToMealWithExceel(service.getAll(SecurityUtil.getAuthUserId()));
    }

    public Collection<MealWithExceed> getFiltered(String dateFrom, String dateTo, String timeFrom, String timeTo) {
        ...
        return convertToMealWithExceel(service.getFiltered(fromDate, toDate, fromTime, toTime, SecurityUtil.getAuthUserId()));
    }

    private Collection<MealWithExceed> convertToMealWithExceel(Collection<Meal> meals) {
